# Generated from expr/Expr.g4 by ANTLR 4.13.1
from antlr4 import *
...
def serializedATN():
    return [
        ...
        0,19,4,1,0,0,0,20,21,5,45,0,0,21,6,1,0,0,0,22,23,5,42,0,0,23,8,1,
        0,0,0,24,25,5,47,0,0,25,10,1,0,0,0,26,27,7,1,0,0,27,28,1,0,0,0,28,
...
class ExprLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "NUM", "PLUS", "SUB", "MUL", "DIV", "WS" ]

    ruleNames = [ "NUM", "PLUS", "SUB", "MUL", "DIV", "WS" ]
