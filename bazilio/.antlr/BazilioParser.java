...
public class BazilioParser extends Parser {
	...
	public static final int
		...
		LTE=19, GT=20, GTE=21, EQ=22, NEQ=23, NOTE=24, NUM=25, PROCEDURE_NAME=26, 
		STRING=27, VAR=28, LEFT_BAR=29, RIGHT_BAR=30, LEFT_BRACKET=31, RIGHT_BRACKET=32, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NEQ", "NOTE", "NUM", "PROCEDURE_NAME", "STRING", "VAR", "LEFT_BAR", 
	...
	public final InstructionsContext instructions() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 335546556L) != 0)) {
				{
				{
				setState(50);
				instruction();
	...
	public final List_expressionContext list_expression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9042923776L) != 0)) {
				{
				{
				setState(105);
				expression(0);
